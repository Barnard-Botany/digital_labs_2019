...
Then, leave fake communities behind! Do one of the following. You will need to write proper code and show results (with annotations) your work in this notebook or create a new notebook: 
